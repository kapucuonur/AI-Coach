...
export function Login({ onLogin }) {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-y-auto md:overflow-hidden bg-black font-sans text-white">
            ...
            {/* --- 2. MAIN CONTENT --- */}
            <div className="relative z-20 flex w-full max-w-3xl flex-col items-center justify-between md:justify-center gap-8 px-4 py-8 md:py-0 h-full md:h-auto min-h-screen md:min-h-0 pointer-events-none md:-mt-32">
