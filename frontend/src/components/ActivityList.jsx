    ...
    return (
        <div className="bg-white dark:bg-garmin-gray rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-colors duration-300 shadow-lg">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-800">
                {activities.map((act) => (
                    <div key={act.activityId} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                        <div className="flex items-center gap-4">
                            <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg">
                                <ActivityIcon type={act.activityType.typeKey} />
                            </div>
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">{act.activityName}</p>
